                                  ...
                                  <div className='flex flex-col gap-2 '>
                                      ...
                                      <div className='flex flex-col lg:flex-row gap-2 lg:gap-4'>
                                         <h6 className='capitalize text-sm text-gray-900 font-semibold'>customer: <span className='text-gray-500'>{order.address.firstName} {order.address.lastName}</span></h6>
                                          <h6 className='capitalize text-sm text-gray-900 font-semibold'>phone: <span className='text-gray-500'>{order.address.phone}</span></h6>
                                      </div>
                                      <h6 className='capitalize text-sm flex flex-row gap-0.5 text-gray-900 font-semibold'>address: <address className='text-gray-500 lowercase'>{order.address.street},{order.address.city},{order.address.state},{order.address.country},{order.address.zipcode}`</address></h6>
                                      <div className='flex flex-col lg:flex-row gap-2 lg:gap-4'>
                                      ...
                                      <div className='flex flex-col lg:flex-row gap-2 lg:gap-4'>
                                         <h6 className='capitalize text-sm text-gray-900 font-semibold'>Date: <span className='text-gray-500'>{new Date(order.createdAt).toDateString()}</span></h6>
                                          <h6 className='capitalize text-sm text-gray-900 font-semibold'>amount: <span className='text-gray-500'>{currency}{order.amount}</span></h6>
                                      </div>
                                  </div>
                                  <div>
                                     <h6 className='capitalize flex flex-row items-center text-sm text-gray-900 font-semibold'>Status:
                                         <span className='text-gray-800 ml-2'>
                                            <select className='bg-gray-100 ring-1 ring-slate-900/50 text-xs font-semibold focus:outline-none focus:border focus:border-gray-200 text-center px-1 py-1' name="" id="" value={order.status}>
